...
<div class="wrapper container" style="margin-bottom: 50px">
	<div class="content">
		...
		<div class="swiper-container ayi-select" style="height: 694px">
			<ul class="swiper-wrapper shop-list">
				<li class="swiper-slide">
					<div class="fl shop-list-item">
						<div class="fl shop text-center"><i class="shop-logo" style="margin-top: 12px"></i></div>
						<div class="fl shop-info">
							<div class="font18" style="margin-top: 10px">天地家政 - 古北店<i class="icon icon-shop"></i></div>
							<div class="icon star star4"></div>
							<div class="light-grey">上海市杨浦区隆昌路590号</div>
						</div>
						<div class="fr icon icon-gold text-center" style="padding-top: 12px"><span class="white font20 bold">999</span></div>
					</div>
					<div class="fr shop-list-item">
						<div class="fl shop text-center"><i class="shop-logo" style="margin-top: 12px"></i></div>
						<div class="fl shop-info">
							<div class="font18" style="margin-top: 10px">天地家政 - 古北店<i class="icon icon-shop"></i></div>
							<div class="icon star star4"></div>
